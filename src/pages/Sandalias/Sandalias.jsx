        ...
        if (result && Array.isArray(result.data)) {
          ...
          if (generos === 'ninos') {
            ...
            if (resultNinas && Array.isArray(resultNinas.data)) {
              ...
              filteredNinas = filteredNinas.filter(item => 'n' === item.genero.toLowerCase() && item.categoria.toLowerCase() === 'sandalias');
          ...
          filteredData = filteredData.filter(item => generoValue === item.genero.toLowerCase() && item.categoria.toLowerCase() === 'sandalias');
